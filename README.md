...
Проект командный, разрабатывался силами нескольких студентов. Моя часть:
- Контейнеризация всех сервисов через Docker и Docker Compose
- Реализация RBAC-middleware в API Gateway
- Отладка сетевого взаимодействия контейнеров и аутентификации
